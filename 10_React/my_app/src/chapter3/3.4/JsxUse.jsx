...
function JsxUse() {
  // JSX의 사용법(문법)
  //  1. 꼭 닫혀야 하는 태그
  // const element = ( // 소괄호 꼭 안적어도 되지만 엘리먼트 구분 하려고 씀
  //   <div>
  //     {/* <div> */}
  //     {/* <input> */}
  //     {/* <br> */}

  //     {/* HTML에서는 input 또는 br 태그를 사용 할 때 닫지 않고 사용 가능 하지만 리엑트 에서는
  //     태그를 열었으면 무조건 닫아야 함 */}
  //     <div></div>
  //     <input />
  //     <br />
  ...
  // const element = (
    ...
    // HTML 중첩 구조가 복잡해지며 그에 따른 스타일을 설정을 할 때도 복잡해 질 수 있음
    // 이럴때 사용하는 것이 React의 Fragment(조각)
  ...
  // 자바스크립트 변수(또는 함수)를 사용해야 할 때에는{} 중괄호 사용
  const name = 'react';
  ...
  // a. style과 className
  // 인라인 스타일은 객체 형태로 작성하는데 background-color처럼 -로 구문되어 있는 이름은 camelCase 형태로 네이밍
  // (예: background colr -> backgroundColor)
